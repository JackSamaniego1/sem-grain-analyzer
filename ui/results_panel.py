...
class ResultsPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.bin_spin = QSpinBox(); self.bin_spin.setRange(0, 100); self.bin_spin.setSpecialValueText("Auto"); self.bin_spin.setValue(0)
        ...
        self.diam_bin_spin = QSpinBox(); self.diam_bin_spin.setRange(0, 100); self.diam_bin_spin.setSpecialValueText("Auto"); self.diam_bin_spin.setValue(0)
