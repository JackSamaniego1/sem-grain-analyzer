...
**Last updated:** 2026-09-24 (demo deck delivered; bugs catalogued for FIX batch; 595 tests)
...
## Next 3 actions
1. FIX batch (high priority PPTX report layout + Excel/UI truncation + formatting bugs).
2. Follow-ups: Build resources icon generation, ReportModel calibration field, CalStatusChip mount, DPI/layout fixes, scale-bar detection robustness, cleanup.
